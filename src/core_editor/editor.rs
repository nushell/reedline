...
impl Editor {
    ...
    pub(crate) fn run_edit_command(&mut self, command: &EditCommand) {
        match command {
            ...
            EditCommand::MoveEmacsWordLeft { select } => self.move_word_left(*select),
            EditCommand::MoveBigWordLeft { select } => self.move_big_word_left(*select),
            EditCommand::MoveEmacsWordRight { select } => self.move_word_right(*select),
            EditCommand::MoveEmacsWordRightStart { select } => self.move_word_right_start(*select),
            EditCommand::MoveBigWordRightStart { select } => {
                self.move_big_word_right_start(*select)
            }
            EditCommand::MoveEmacsWordRightEnd { select } => self.move_word_right_end(*select),
            ...
            EditCommand::CutEmacsWordLeft => self.cut_word_left(),
            EditCommand::CutBigWordLeft => self.cut_big_word_left(),
            EditCommand::CutViWordLeft => self.cut_vi_word_left(),
            EditCommand::CutEmacsWordRight => self.cut_word_right(),
            ...
            EditCommand::CutEmacsWordRightToNext => self.cut_word_right_to_next(),
            ...
            EditCommand::CopyEmacsWordLeft => self.copy_word_left(),
            EditCommand::CopyBigWordLeft => self.copy_big_word_left(),
            EditCommand::CopyViWordLeft => self.copy_vi_word_left(),
            EditCommand::CopyEmacsWordRight => self.copy_word_right(),
            ...
            EditCommand::CopyEmacsWordRightToNext => self.copy_word_right_to_next(),
